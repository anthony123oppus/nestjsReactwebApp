...
export default {
  ...
  theme: {
    backgroundImage: {
      login: 'url("/peakpx.jpg")',
    },
    fontFamily: {
      satoshi: ['Satoshi', 'sans-serif'],
      inter: ["Inter", "sans-serif"],
      "work-sans": ["Work Sans", "sans-serif"],
      coolFont : ["UnifrakturMaguntia", "cursive"]
    },
    screens: {
      '2xsm': '375px',
      xsm: '425px',
    ...
    extend: {
      ...
      boxShadow: {
        project : ' rgba(136, 165, 191, 0.48) 6px 2px 16px 0px, rgba(255, 255, 255, 0.8) -6px -2px 16px 0px;',
        buttonShadow : 'rgba(75, 0, 130, 0.2) 6px 2px 16px 0px, rgba(75, 0, 130, 0.1) -6px -2px 16px 0px;',
        projectWidget : 'rgba(50, 50, 93, 0.25) 0px 30px 60px -12px inset, rgba(0, 0, 0, 0.3) 0px 18px 36px -18px inset;',
